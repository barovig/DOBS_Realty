...
INSERT INTO `agents` VALUES (1,'Sue Roberts','555-1234','+555-9876','sue@homesellers.com','Sue.Roberts','c3aab1ba2d788776796500d6871cd007a40e31ee674bda0c299967adb83f5e75bd7a29427f5b3df51be7ed197941b0d66e3e3be70f9746ee47eb99480104d675'),(2,'Natasha Watkins','555-1357','555-9876','tasha@homesellers.com','Natasha.Watkins','ec7ddbbeb48ecc7db03ac20bcdf209776428fcb871cca7bbbf1aaa35ae72b6302e8af3bad24367d14655653d986045841e53e64b84dd4e7ab6467f82afa028e4'),(3,'Chris Clarkson','555-2468','555-6767','chris@homesellers.com','Chris.Clarkson','4bbb6887a3fe49994c3a46c90ff0c155c4ac10334c302fb8d358e9eb430da4fcb950010721f248889905a904722ce20b4886408b2dc9bda23fef6e0565bad23b'),(4,'Laura Blain','555-9898','555-6767','laura@homesellers.com','Laura.Blain','efefd2d749ab6ec8af13b8086fb841a7fb087f5456148a58757e168e85c1b56d378080430bda70e8b68630037e0489c6d72bec20079562c4a577ee13ffca2502'),(5,'Dave Lindale','555-8833','555-9876','dave@homesellers.com','Dave.Lindale','1c2425d9307f6dd03ed917e693d4c4532ca0c2466d85e6261f77418c01d00fa6ce15a00a9d9ae14a487291e87463dfd30283bc30ccf45dd05cbc90aa2be39b6f');
/*!40000 ALTER TABLE `agents` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `archive_properties`
--

DROP TABLE IF EXISTS `archive_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `archive_properties` (
...
--
-- Dumping data for table `archive_properties`
--

LOCK TABLES `archive_properties` WRITE;
/*!40000 ALTER TABLE `archive_properties` DISABLE KEYS */;
INSERT INTO `archive_properties` VALUES (2,'new street','Limerick',4021453,1,1,1,3,1000,'D2','asdasd','123x321',2,3,1,'4021453.jpg',999999999,'2017-01-26'),(3,'new street','Limerick',4021453,1,1,1,3,1000,'D1','description here','123x321',2,1,1,'4021453.jpg',999999999,'2017-01-27');
/*!40000 ALTER TABLE `archive_properties` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `garagetypes` VALUES (1,'attached'),(2,'detached'),(3,'none'),(4,'carport');
...
CREATE TABLE `properties` (
  ...
  KEY `fk_properties_garage_idx` (`garageId`),
  KEY `fk_properties_styles_idx` (`styleId`),
  KEY `fk_properties_propTypes_idx` (`typeId`),
  KEY `fk_properties_agents_idx` (`agentId`),
  CONSTRAINT `fk_properties_agents` FOREIGN KEY (`agentId`) REFERENCES `agents` (`agentId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_properties_garage` FOREIGN KEY (`garageId`) REFERENCES `garagetypes` (`garageId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_properties_propTypes` FOREIGN KEY (`typeId`) REFERENCES `propertytypes` (`typeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_properties_styles` FOREIGN KEY (`styleId`) REFERENCES `styles` (`styleId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `propertytypes` VALUES (1,'Residential-single'),(2,'Residential-multi'),(3,'Commercial'),(4,'Production'),(5,'Studio');
...
INSERT INTO `roles` VALUES ('admin','admin'),('agent','agent'),('Sue.Roberts','agent'),('Natasha.Watkins','agent'),('Chris Clarkson','agent'),('Laura Blain','agent'),('Dave Lindale','agent');
...
INSERT INTO `salts` VALUES ('zax1ywMzcacwKffdnRjgUP/7VqFG3gu77XdyLO17X2EsT++RB+/GNnbzRLuuV6f/sl+8NuGGvas1eH3PJeP0ZETPP+kIlrXUikbMfqLUGacYoJfibfEQpj8fRuj/ACd13h0w0gfS3/tHNlwN6Xn0UdcQ8y8+uEf0hIU+HQieBF8=','Sue.Roberts'),('CbzIypJbDpUFD2CW6/jcprKk1mYPq/+Z4/nCofSqE8eMz4oLhJ3zXJwQzXxyQGd0Yn5pfz0RpXBlaFBQC5iJm73DSYzBJVPbFBhNNuuKsMGmTVCZ1n0dLcU5lkfZxai1oYCxw5QkDJ+rxU4CXY8a1KJOCpwPzeOD2anmzAsoaVc=','Natasha.Watkins'),('hmGDfbDWi1dDRbx1Md3vUBtg9PE2sq8v0PuVIOjAqQoLhIVhzVjZl1ij+zw7OeZWguTlj6hbJJD4D46ZxA6+SHJ2HZh8GrqM9cLaneDiZvPyWCDElp/rZE7PEXddTA+6gXVL8WgfRhSXPOqcWuw88gp/H42QuUgXBgbl8OcA+bs=','Chris.Clarkson'),('h60+BLFUdoPMZtWMjPCuiBgo/cCbKgsyhTZcAYPhx3bsVKIuIgPqCRBlmAeRC8N8Hjpw8mkkGCgmNXNlx8OBnDvnvtgCX6h/1YfwA3JpZTIDOxrL8YYREXw6hoABNurcmj5PPZXDkALjgTY8bzEJdEobqXjfIEdDzktvi5sECPo=','Laura.Blain'),('bIlehYuLnSIzK6QmdsPfrOUgPXJHu05vdNx3ZdKkLGhQOUXZ/9cljXtC62GwNk8YGlh89OX0GzUlgDfxqZUZ98P7v0WV+yWp7SzN05431emjSxZmyqvHQ72r6j6fTQVjJ8M7XcctTLlyGvHXG595KhRI/JaMNGKCtpXA6ld6HPQ=','Dave.Lindale');
...
INSERT INTO `styles` VALUES (1,'Bungalow'),(2,'Semi Detached'),(3,'Detached '),(4,'Cottage'),(5,'Terrace'),(6,'Mansion'),(7,'Castle'),(8,'Duplex'),(9,'Condo'),(10,'Mansion'),(11,'Other');
...
-- Dump completed on 2017-01-27 11:09:30
